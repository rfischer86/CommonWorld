...
@Component({
  selector: 'app-search-field-popup',
  templateUrl: './searchField.component.html',
  styleUrls: ['./searchField.component.scss']
})
export class PopupSearchFieldComponent{
  @Input() parentId: string;
  @Input() popupAction = [] as  PopupAction<PopupSearchFieldComponent>[];
  ...
  clickEl(group: PopupAction<PopupSearchFieldComponent>) {
